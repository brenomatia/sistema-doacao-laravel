...
<body>
    ...
    <div class="container" style="margin-top: 5%;">
        <div class="row justify-content-center">
            <div class="col-md-5">
                <form action="{{ route('login_access') }}" method="POST" class="p-4 p-md-5 border rounded-3">
                    @csrf
                    ...
                    <button type="submit" class="btn bg-gradient-danger col-12 mb-2 text-white">ENTRAR</button>

                    <a href="{{ URL::route('home_cadastro') }}"><button type="button"
                            class="btn bg-gradient-danger col-12 text-white">CADASTRAR</button></a>
                </form>
            </div>
        </div>
    </div>
