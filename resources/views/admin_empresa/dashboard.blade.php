...
<div class="container col-12 p-3">
    <div class="row">
        ...
        <div class="col-lg-4 col-md-6 mb-4">
            <div class="card" style="border-radius: 10px; box-shadow: 0 0 10px rgba(0, 0, 0, 0.35); background-color: #38414A; color: white;">
                ...
                <div class="card-body">
                    <div class="table-responsive">
                        <table class="table">
                            <thead>
                                <tr>
                                    <th class="bg-gradient-success text-white rounded-left border-0" style="font-size: 14px;">NOME CLIENTE</th>
                                    <th class="bg-gradient-success text-white rounded-right border-0" style="font-size: 14px;">VALOR</th>
                ...
                <div class="card-body">
                    <div class="table-responsive">
                        <table class="table">
                            <thead>
                                <tr>
                                    <th class="bg-gradient-success text-white rounded-left border-0" style="font-size: 14px;">Nome user</th>
                                    <th class="bg-gradient-success text-white rounded-right border-0" style="font-size: 14px;">Alteração</th>
                                    <!-- Adicione mais colunas conforme necessário -->
                                </tr>
                            </thead>
                            <tbody>
                                @forelse ($ultimosAlteracoes as $alteracoes)
                                    <tr>
                                        ...
                                        <td class="border-0" style="font-size: 14px; color: #2DCEAB;">{{ $alteracoes->mod }}</td>
                                    </tr>
                                @empty
                                    <tr>
                                        <td colspan="2" class="text-center border-0">Nenhum registro encontrado</td>
